...
def home_page():
    ...
    df = load_table('.\\util\\data\\entry.tsv')
    show_st_structure(mask_equal(df, pdb_code_col, "6oim"),#6oim
            zoom=1.2,
            width=300,
            height=250,
            cartoon_trans=0,
    ...
    img = Image.open(
        get_file_path(
            ...
            dir_path='D:\\desktop\\project\\rascore-main\\src\\rascore\\util\\data',
        )
    )
