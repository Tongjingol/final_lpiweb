...
def overview_page():
    ...
    - The *Rascore* database presents a continually updated dataset of RAS structures in the PDB that are conformationally classified and annotated for their molecular contents (*now  structures*).
    """
    )
    ...
    img = Image.open("./src/rascore/util/data/rascore_figure.png")
